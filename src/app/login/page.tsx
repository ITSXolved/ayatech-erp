                            ...
                            <form className="space-y-5" action={login}>
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-1">
                                        <label style={{ display: 'block', fontSize: '13px', fontWeight: 600, color: '#ccd6f6' }}>
                                            Password
                                        </label>
                                        <a href="/forgot-password" style={{ fontSize: '12px', color: '#64ffda', textDecoration: 'none', fontWeight: 500 }}>
                                            Forgot password?
                                        </a>
                                    </div>
                                    <input
